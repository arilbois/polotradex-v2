...
INSERT INTO "new_Configuration" ("createdAt", "id", "overboughtThreshold", "oversoldThreshold", "rsiPeriod", "stopLossPercentage", "takeProfitPercentage", "timeframe", "tradingSymbol", "updatedAt") SELECT "createdAt", "id", "overboughtThreshold", "oversoldThreshold", "rsiPeriod", "stopLossPercentage", "takeProfitPercentage", "timeframe", "tradingSymbol", "updatedAt" FROM "Configuration";
